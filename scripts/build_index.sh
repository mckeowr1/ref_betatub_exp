...
#SBATCH -o /vast/eande106/projects/Ryan/ref_betatub_exp/data/proc/ref_transcriptomes/logs/index.out  # Standard output log
#SBATCH -e /vast/eande106/projects/Ryan/ref_betatub_exp/data/proc//ref_transcriptomes/logs/index.err  # Standard error log
...
transcriptome="data/proc/ref_transcriptomes/c_briggsae/c_briggsae.QX1410_nanopore.Feb2020.csq.gff3.fa"
